...
class _LoginPageState extends State<LoginPage> {
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                color: _selectedRole == 'patient'
                                    ...
                                    : (_hoveredRole == 'patient' ? Colors.grey[100] : Colors.transparent),
                                border: Border.all(
                                  color: _selectedRole == 'patient'
                                      ? const Color(0xFF0088CC)
                                      : (_hoveredRole == 'patient' ? const Color(0xFF0088CC).withOpacity(0.5) : const Color(0xFFE2E8F0)),
                                  width: 2,
                                ),
                              ...
                              child: Center(
                                child: Text(
                                  ...
                                  style: TextStyle(
                                    fontSize: 16,
                                    fontWeight: FontWeight.bold,
                                    color: _selectedRole == 'patient' ? const Color(0xFF0088CC) : const Color(0xFF64748B),
                                  ),
                                ),
                              ),
                            ),
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                color: _selectedRole == 'doctor'
                                    ? const Color(0xFF0088CC).withOpacity(0.1)
                                    : (_hoveredRole == 'doctor' ? Colors.grey[100] : Colors.transparent),
                                border: Border.all(
                                  color: _selectedRole == 'doctor'
                                      ? const Color(0xFF0088CC)
                                      : (_hoveredRole == 'doctor' ? const Color(0xFF0088CC).withOpacity(0.5) : const Color(0xFFE2E8F0)),
                                  width: 2,
                                ),
                                borderRadius: BorderRadius.circular(12),
                              ),
                              child: Center(
                                child: Text(
                                  ...
                                  style: TextStyle(
                                    fontSize: 16,
                                    fontWeight: FontWeight.bold,
                                    color: _selectedRole == 'doctor' ? const Color(0xFF0088CC) : const Color(0xFF64748B),
                                  ),
                                ),
                              ),
                            ),
                ...
                _buildTextField(Icons.lock_outline, 'Password', '••••••••', obscure: true, controller: _passwordController),
  ...
  Widget _buildTextField(IconData icon, String label, String hint, {bool obscure = false, TextEditingController? controller}) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(
