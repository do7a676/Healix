...
class _DoctorProfilePageState extends State<DoctorProfilePage> {
  ...
  Widget _buildProfileHeader() {
    ...
    return Container(
      ...
      child: Row(children: [
        Stack(children: [
          Container(width: 64, height: 64, decoration: const BoxDecoration(color: Color(0xFF1E293B), shape: BoxShape.circle), child: const Icon(Icons.person, color: Colors.white, size: 40)),
        ...
        Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Text('Dr. Julian Sterling', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18, color: textColor)),
          const SizedBox(height: 4),
          Text('Chief Cardiologist • St. Mary\'s Hospital', style: TextStyle(color: Colors.blueGrey.shade400, fontSize: 13, height: 1.4)),
        ])),
      ]),
    );
  }
                ...
                children: [
                  ...
                  Expanded(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        const Text('Lab Report Prefs', style: TextStyle(color: Color(0xFF0F172A), fontSize: 14, fontWeight: FontWeight.w500)),
                  ...
                  Expanded(
                    child: GestureDetector(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          color: _labPrefs == 'Real-time' ? const Color(0xFF00C4D4) : const Color(0xFFF1F5F9),
                        ...
                        child: Center(
                          child: Text(
                            'Real-time',
                            style: TextStyle(
                              color: _labPrefs == 'Real-time' ? Colors.white : const Color(0xFF334155),
                  ...
                  Expanded(
                    child: GestureDetector(
                      ...
                      child: Container(
                        padding: const EdgeInsets.symmetric(vertical: 12),
                        decoration: BoxDecoration(
                          color: _labPrefs == 'End of Day' ? const Color(0xFF00C4D4) : const Color(0xFFF1F5F9),
                          borderRadius: BorderRadius.circular(8),
                        ),
                        child: Center(
                          child: Text(
                            'End of Day',
                            style: TextStyle(
                              color: _labPrefs == 'End of Day' ? Colors.white : const Color(0xFF334155),
                              fontWeight: FontWeight.w500,
                              fontSize: 14,
                            ),
                          ),
