...
class _ScheduleAppointmentPageState extends State<ScheduleAppointmentPage> {
  DateTime _selectedDay = DateTime.now().add(const Duration(days: 2));
  ...
  final List<String> _morningSlots = ['09:00 AM', '09:30 AM', '10:00 AM', '11:00 AM'];
  final List<String> _afternoonSlots = ['01:00 PM', '01:30 PM', '02:00 PM', '03:30 PM', '04:00 PM'];
  final List<String> _eveningSlots = ['06:00 PM', '06:30 PM', '07:00 PM'];
    ...
    return Container(
      ...
      child: Row(
        children: [
          Container(
            width: 64, height: 64,
            decoration: BoxDecoration(borderRadius: BorderRadius.circular(12), color: const Color(0xFF00C4D4)),
          ...
          Expanded(child: Column(
            ...
            children: [
              ...
              Text('Cardiologist • 12 years exp.', style: TextStyle(color: subTextColor, fontSize: 13)),
          ...
          Container(
            ...
            decoration: BoxDecoration(color: const Color(0xFFE0FAFC), borderRadius: BorderRadius.circular(20)),
            child: const Text('\$45.00', style: TextStyle(color: Color(0xFF0088CC), fontWeight: FontWeight.bold, fontSize: 13)),
          ),
        ],
      ),
    );
