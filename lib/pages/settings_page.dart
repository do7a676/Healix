...
class _SettingsPageState extends State<SettingsPage> {
  ...
  Widget _buildSectionHeader(IconData icon, String title) {
    return Row(
      children: [
        Icon(icon, color: const Color(0xFF006688), size: 20),
    ...
    return Column(
      children: [
        ListTile(
          ...
          title: Text(
            title,
            style: const TextStyle(fontWeight: FontWeight.w600, color: Color(0xFF334155), fontSize: 15),
          ),
          subtitle: Text(
            subtitle,
            style: const TextStyle(color: Color(0xFF94A3B8), fontSize: 13),
          ),
          trailing: trailing ?? const Icon(Icons.arrow_forward_ios, size: 14, color: Color(0xFFCBD5E1)),
        ),
        if (!isLast) const Divider(height: 1, color: Color(0xFFF1F5F9), indent: 20, endIndent: 20),
      ],
    );
  }
